        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between text-xs">
            <div className="flex items-center gap-1">
              ...
              <span className="font-semibold text-gray-600">{statusCounts.done}</span>
            </div>
            <div className="flex items-center gap-1">
              <Clock className="w-3 h-3 text-blue-500" />
              <span className="font-semibold text-gray-600">{statusCounts.in_progress}</span>
            </div>
            <div className="flex items-center gap-1">
              <Circle className="w-3 h-3 text-gray-400" />
              <span className="font-semibold text-gray-600">{statusCounts.todo}</span>
            </div>
          </div>
        </div>
      )}
